  ...
  return (
    <Row>
      <Col>
        ...
        <p>
          <b>Attendance (max 2 unexcused absences):</b> TWO unexcused absences from our lecture and discussion are allowed. For a class to be excused, you MUST get advance permission (just <a href="mailto:leetcodedecal@gmail.com">email us</a> we’re nice!). Having more than 2 unexcused classes will result in an automatic No Pass (NP). Please reach out to us if you have any questions or concerns.
        ...
        <p>
          ...
          All the homework is released <a href="https://leetcode101.com">on our website</a> and is due every Monday at 11:59 PM. 
          Each homework is graded on effort and full credit will be given if the problem submission has been attempted. 
          Your lowest two homework scores will be dropped. 
          There are ten graded homework assignments over the course of the semester. 
          The assignments consist of several leetcode problems that should be completed and submitted <a href="https://www.leetcode.com">on the leetcode website</a>. 
          To get credit for completing the problems, students will fill out a Gradescope assignment with their effort as well as a screenshot of each leetcode problem submission. 
        </p>
        <p>
          The weekly homework assignments will be one of the important parts of this class. 
          If you successfully work through and understand the solution to every problem, you will be ready for any coding interview. 
          Only attempts are required to complete the homework and pass, because we encourage you to struggle with the problems for a bit before looking at the answer. 
          We will host office hours so you get a chance to talk to us about the problems.
        </p>
        <p>
          <b>Mock Interviews</b>:
          There are two mock interviews that are graded on completion. 
          There will be a form on gradescope to fill out after your mock interview to receive credit.
        </p>
      </Col>
    </Row>
  );
